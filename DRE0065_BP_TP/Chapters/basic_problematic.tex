...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{Figures/worst_case.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{Figures/average_case.jpg}
...
U této metody je důležité, aby nahromaděná rezerva v průběhu celé posloupnosti operací nikdy neklesla pod nulu. Účetní metoda tak názorně ukazuje, že některé operace mohou vytvářet rezervu pro budoucí nákladnější kroky.
