...
Implementace komponenty byla realizována jako dynamická webová aplikace s využitím technologií HTML, CSS a JS. Jazyk HTML slouží pro definici struktury celé stránky, CSS pro její vizuální styl a responzivní zobrazení a JS pro zajištění aplikační logiky. Dynamická práce s obsahem stránky je realizována prostřednictvím manipulace s DOM, což umožňuje aktualizaci jednotlivých částí UI bez nutnosti opětovného načítání celé stránky. Pro vizuální animační efekty v pozadí stránky bylo využito také Canvas API.

V implementaci byly také využity vybrané knihovny, které usnadnily práci s UI. Pro stylování a rozložení stránky byla použita knihovna Bootstrap, pro práci s ikonami knihovna Font Awesome a pro podporu JS komponent Bootstrapu knihovna jQuery spolu s knihovnou Popper.js. Aplikace nevyužívá žádné externí API, veškerá logika je realizována na straně klienta.
...
const ALG_REGISTRY = Object.freeze({
  ...
  splayTree: {
    ...
    manual: {type: 'actionInput', start: typesParamsStartSplayManualWithValues},
...
\begin{figure}[H]
    ...
    \subfloat[Hlavní stránka aplikace na desktopovém zařízení]{%
        \includegraphics[width=0.7\textwidth]{Figures/main_page_algorithm_selection.png}}
    \hfill
    \subfloat[Hlavní stránka aplikace na mobilním zařízení]{%
        \includegraphics[width=0.3\textwidth]{Figures/mobile_main_page.png}}
...
Výsledná aplikace je dostupná pomocí protokolu HTTP na adrese URL \url{https://homel.vsb.cz/~dre0065/DRE0065_BP/html/}.