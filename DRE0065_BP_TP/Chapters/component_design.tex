...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{Figures/input_modes_menu.jpg}
...
\begin{figure}[H]
    \centering
    \subfloat[Ruční zadávání vstupů]{\includegraphics[width=0.4\textwidth]{Figures/input_manual.jpg}}
    \hfill
    \subfloat[Náhodné generování vstupů]{\includegraphics[width=0.4\textwidth]{Figures/input_random.jpg}} \\[0.5em]
    \subfloat[Volba typického případu]{\includegraphics[width=0.4\textwidth]{Figures/input_specialcases.jpg}}
    \hfill
    \subfloat[Zadávání vstupů pomocí syntaxe příkazů]{\includegraphics[width=0.4\textwidth]{Figures/input_syntax.jpg}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/syntax_step_mode.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/specialcases_auto_mode.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/counters_potential.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/history_info_panel.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{Figures/manual_sideinfo_panel.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/main_page_algorithm_selection.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/simulation_controls.jpg}
...
\begin{figure}[htbp]
    \centering
    \subfloat[Zásobník]{\includegraphics[width=0.63\textwidth]{Figures/stack_visualization.jpg}}
    \hfill
    \subfloat[Fronta využívající dva zásobníky]{\includegraphics[width=0.63\textwidth]{Figures/queue_visualization.jpg}}
    \hfill
    \subfloat[Splay strom]{\includegraphics[width=0.63\textwidth]{Figures/splay_visualization.jpg}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/algorithm_info_panel.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.99\textwidth]{Figures/UML_component_diagram.jpg}
