...
function langAppApplyCommonStaticTexts(Lall){
  ...
  _setText('scExecutionModeLabel', Lall.scExecutionModeLabel);
  _setText('scExecutionModeAutoLabel', Lall.executionModeAuto);
  _setText('scExecutionModeManualLabel', Lall.executionModeManual);
  _setText('footerText', Lall.footerText);
  _setText('closeBtn', Lall.closeBtn);
  _setText('specialCasesCloseBtn', Lall.closeBtn);
...
function langAppApplyParameterButtonTexts(Lall){
  ...
  buttons[2].textContent = Lall.specialCasesButton;
...
function langAppApplySpecialCasesModalTexts(Lall){
  _setText('specialCasesModalLabel', Lall.selectCase);
  _setText('specialCasesModalText', Lall.specialCasesDescription);
}
...
function langAppRefreshMultipopView(){
  if(langAppGetEl('mpScPanel')){
    if(typeof rebuildMpSpecialCasesForLanguage === 'function')
      rebuildMpSpecialCasesForLanguage();
...
function langAppRefreshQueueView(){
  if(langAppGetEl('qScPanel')){
    if(typeof rebuildQueueSpecialCasesForLanguage === 'function')
      rebuildQueueSpecialCasesForLanguage();
...
function langAppRefreshRandomOperationPreviews(){
  if(typeof mpIsRandomMode !== 'undefined' && mpIsRandomMode && typeof mpRenderRandomPreview === 'function')
    mpRenderRandomPreview(false);
  if(typeof qIsRandomMode !== 'undefined' && qIsRandomMode && typeof qRenderRandomPreview === 'function')
    qRenderRandomPreview(false);
  if(typeof sIsRandomMode !== 'undefined' && sIsRandomMode && typeof sRenderRandomPreview === 'function')
    sRenderRandomPreview(false);
}
