window.translations = {
  en:{
    common:{
        ...
        bestWorstDescription: "Choose one of the prepared characteristic scenarios for the selected algorithm:",
        ...
        bestWorstHistoryTitle: "Special cases history",
    ...
    multipop:{
        ...
        multipopDescription: `
                ...
                <ul>
                    ...
                    <li><strong>Total cost of a long sequence</strong>: linear in the number of actually performed elementary insertions and removals</li>
                </ul>
                <p>
    ...
    queue:{
        ...
        queue2StacksDescription: `
                ...
                <h6 class="mt-3"><strong>Amortized complexity</strong></h6>
                <ul>
                    <li><strong>Amortized cost of Enqueue</strong>: O(1)</li>
                    <li><strong>Amortized cost of Dequeue</strong>: O(1)</li>
                    <li><strong>Amortized cost per operation in a sequence</strong>: O(1)</li>
                </ul>
                <p>
                    The expensive transfer does not happen repeatedly for the same elements.
                    Once an element is moved to <strong>Stack Out</strong>, it will never be moved back.
                    This is the key reason why the long-term average cost stays constant.
                </p>
                ...
                <ul>
                    <li><strong>Φ</strong> is the value of the potential function.</li>
                    <li><strong>S<sub>in</sub></strong> is <strong>Stack In</strong>.</li>
                    <li><strong>|S<sub>in</sub>|</strong> is the number of elements currently stored in <strong>Stack In</strong>.</li>
                </ul>
                <p>
  ...
  cz:{
    common:{
        ...
        bestWorstButton: "Speciální případy",
        ...
        bestWorstDescription: "Vyberte jeden z připravených typických scénářů pro zvolený algoritmus:",
        ...
        bwExecutionModeLabel: "Režim provádění",
        ...
        bestWorstHistoryTitle: "Historie speciálních případů",
    ...
    multipop:{
        ...
        multipopDescription: `
                ...
                <p>
                    To znamená, že i když jeden příkaz multipop odebere více prvků, každý takto odebraný prvek musel být dříve vložen
                ...
                <ul>
                    ...
                    <li><strong>Nejhorší případ multipopu vzhledem k aktuální velikosti zásobníku n</strong>: O(min(k, n))</li>
                </ul>

                <h6 class="mt-3"><strong>Amortizovaná složitost</strong></h6>
                <ul>
                    <li><strong>Amortizovaná cena na jednu operaci v sekvenci</strong>: O(1)</li>
                    <li><strong>Celková cena dlouhé sekvence</strong>: lineární vzhledem k počtu skutečně provedených elementárních vložení a odebrání</li>
                </ul>
                <p>
        ...
        mpScenario03Title: "Částečný úklid pomocí multipopu",
        mpScenario03Desc: "Zásobník se nejprve zvětší a potom se jedním příkazem Odebrat více odstraní jen jeho část.",
        mpScenario04Title: "Úplné vyčištění pomocí multipopu",
        mpScenario04Desc: "Zásobník se naplní a potom se jedním větším multipopem vyčistí. Ukazuje jednu lokálně drahou operaci.",
        mpScenario05Title: "Multipop s přesahem",
        ...
        mpScenario09Title: "Více malých multipopů",
    ...
    queue:{
        ...
        queue2StacksDescription: `
                ...
                <h6 class="mt-3"><strong>Amortizovaná složitost</strong></h6>
                <ul>
                    <li><strong>Amortizovaná cena operace Vložit do fronty</strong>: O(1)</li>
                    <li><strong>Amortizovaná cena operace Odebrat z fronty</strong>: O(1)</li>
                    <li><strong>Amortizovaná cena na operaci v celé sekvenci</strong>: O(1)</li>
                </ul>
                <p>
                    Drahý přesun se neopakuje stále nad stejnými prvky.
                    Jakmile se prvek jednou přesune do <strong>výstupního zásobníku</strong>,
                    už se zpět nevrací. To je hlavní důvod, proč dlouhodobá průměrná cena zůstává konstantní.
                </p>
                ...
                <p>
                    ...
                    V této vizualizaci tedy potenciál vyjadřuje, kolik prvků právě čeká ve vstupním zásobníku,
    ...
    splay:{
        ...
        splayTreeDescription: `
                <p>
                    ...
                    pomocí rotací přesune blíže ke kořeni. Tento proces restrukturalizace se nazývá <strong>operace Splay</strong>.
                </p>
